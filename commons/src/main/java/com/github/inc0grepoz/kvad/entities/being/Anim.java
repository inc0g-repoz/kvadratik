...
public enum Anim {
    ...
    RUN_D(100, 0.24, Way.D,
            ...
            "idle_d.png",
            "run_d_2.png"),
    WALK_W(200, 0.08, Way.W,
            "walk_w_1.png",
            "idle_w.png",
            "walk_w_2.png",
            "idle_w.png"),
    WALK_A(200, 0.08, Way.A,
            "walk_a_1.png",
            "idle_a.png",
            "walk_a_2.png",
            "idle_a.png"),
    WALK_S(200, 0.08, Way.S,
            "walk_s_1.png",
            "idle_s.png",
            "walk_s_2.png",
            "idle_s.png"),
    WALK_D(200, 0.08, Way.D,
            "walk_d_1.png",
            "idle_d.png",
            "walk_d_2.png",
            "idle_d.png");
    ...
    Anim(long delay, double speed, Way way, String... paths) {
        ...
        for (int i = 0; i < bt.length; i++) {
            ...
            for (int j = 0; j < btImages.length; j++) {
                ...
                btImages[j] = Platform.getInstance().getAssetsProvider().image(btPath);
            }
